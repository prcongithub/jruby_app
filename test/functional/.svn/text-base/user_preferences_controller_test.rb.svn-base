...
class UserPreferencesControllerTest < ActionController::TestCase
  ...
  test "should create user_preference" do
    assert_difference('UserPreference.count') do
      post :create, :user_preference => { :item_id => @user_preference.item_id, :preference => @user_preference.preference, :user_id => @user_preference.user_id }
    end
  ...
  test "should update user_preference" do
    put :update, :id => @user_preference, :user_preference => { :item_id => @user_preference.item_id, :preference => @user_preference.preference, :user_id => @user_preference.user_id }
    assert_redirected_to user_preference_path(assigns(:user_preference))
  end
